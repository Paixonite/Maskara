...
func _on_right_body_shape_entered(body_rid: RID, body: Node2D, body_shape_index: int, local_shape_index: int):
	healthManager.damage(1)

func _on_left_body_shape_entered(body_rid: RID, body: Node2D, body_shape_index: int, local_shape_index: int):
	healthManager.damage(1)
