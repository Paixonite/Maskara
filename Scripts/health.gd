...
func _process(delta: float) -> void:
	...
	if cooldown :
		material_Walk.set_shader_parameter("tint_color", Vector4(1, 1, 1, 1))
		material_Idle.set_shader_parameter("tint_color", Vector4(1, 1, 1, 1))
		aux = cos(a)
		...
		a = 0
		material_Walk.set_shader_parameter("tint_color", originalTint)
		material_Idle.set_shader_parameter("tint_color", originalTint)
